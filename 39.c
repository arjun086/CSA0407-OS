...
void c_scan(int requests[], int num_requests, int initial_position, int max_cylinder) {
...
int main() {
    ...
    c_scan(requests, num_requests, initial_position, max_cylinder);
